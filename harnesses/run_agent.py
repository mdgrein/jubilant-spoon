...
Examples:
  ...
  python run_agent.py "Complex task" --max-iterations 100 --timeout 600
    ...
    parser.add_argument("prompt", type=str, help="Task for the agent to perform")
    parser.add_argument(
    ...
    try:
        ...
        if (
            "max_iterations" in result["termination_reason"]
            or "timeout" in result["termination_reason"]
        ):
            sys.exit(1)
