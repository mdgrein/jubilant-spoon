...
-- =====================================================================
-- TEMPLATE: Four Tasks (fibonacci / binary_sort / case_converter / all_join_in)
-- =====================================================================
INSERT OR IGNORE INTO pipeline_templates (template_id, name, description, default_vendor, default_model, created_at, updated_at) VALUES (
    'template-four-tasks',
    'Four Tasks (fib / sort / case / join)',
    'Hard-coded TDD pipeline: fibonacci, binary_sort, case_converter in parallel (Stage 1), then all_join_in after all three pass (Stage 2). Each task: tester -> dev -> verifier.',
    'local-ollama', 'qwen3:8b',
    '2026-03-04T00:00:00Z', '2026-03-04T00:00:00Z'
);
INSERT OR IGNORE INTO template_stages (template_stage_id, template_id, name, stage_order) VALUES
    ('ts-4t-1', 'template-four-tasks', 'parallel-tasks', 1),
    ('ts-4t-2', 'template-four-tasks', 'join-task',      2);

INSERT OR IGNORE INTO template_jobs
    (template_job_id, template_stage_id, agent_type, name, prompt_template, command_template, max_iterations, timeout_seconds, vendor, model)
VALUES
    -- fibonacci: tester
    ('tj-4t-fib-test', 'ts-4t-1', 'tester', 'fibonacci tester',
     'FILENAME: fibonacci.py

Write a Python function called fibonacci(n) that returns the nth Fibonacci number. Include an if __name__ == ''__main__'' block that demonstrates it with a few values.',
     'python -u harnesses/test_harness.py {{job_id}}',
     30, 600, NULL, NULL),

    -- fibonacci: dev
    ('tj-4t-fib-dev', 'ts-4t-1', 'dev', 'fibonacci dev',
     'FILENAME: fibonacci.py

Write a Python function called fibonacci(n) that returns the nth Fibonacci number. Include an if __name__ == ''__main__'' block that demonstrates it with a few values.',
     'python -u harnesses/dev_harness.py {{job_id}}',
     30, 600, NULL, NULL),

    -- fibonacci: verifier
    ('tj-4t-fib-ver', 'ts-4t-1', 'verifier', 'fibonacci verifier',
     'FILENAME: fibonacci.py

Write a Python function called fibonacci(n) that returns the nth Fibonacci number. Include an if __name__ == ''__main__'' block that demonstrates it with a few values.',
     'python -u harnesses/verify_harness.py {{job_id}}',
     20, 300, NULL, NULL),

    -- binary_sort: tester
    ('tj-4t-bsort-test', 'ts-4t-1', 'tester', 'binary_sort tester',
     'FILENAME: binary_sort.py

Write a Python function called binary_sort(arr) that returns a sorted copy of the input list using Python''s built-in sort. Include an if __name__ == ''__main__'' block with an example.',
     'python -u harnesses/test_harness.py {{job_id}}',
     30, 600, NULL, NULL),

    -- binary_sort: dev
    ('tj-4t-bsort-dev', 'ts-4t-1', 'dev', 'binary_sort dev',
     'FILENAME: binary_sort.py
...
Write a Python function called binary_sort(arr) that returns a sorted copy of the input list using Python''s built-in sort. Include an if __name__ == ''__main__'' block with an example.',
    ...
    -- binary_sort: verifier
    ('tj-4t-bsort-ver', 'ts-4t-1', 'verifier', 'binary_sort verifier',
     'FILENAME: binary_sort.py
...
Write a Python function called binary_sort(arr) that returns a sorted copy of the input list using Python''s built-in sort. Include an if __name__ == ''__main__'' block with an example.',
    ...
    -- case_converter: tester
    ('tj-4t-case-test', 'ts-4t-1', 'tester', 'case_converter tester',
     'FILENAME: case_converter.py

Write a Python function called convert_case(text, target) that converts text to ''lower'', ''upper'', ''kebab'', or ''camel'' case. Include an if __name__ == ''__main__'' block showing all four conversions.',
     'python -u harnesses/test_harness.py {{job_id}}',
     30, 600, NULL, NULL),

    -- case_converter: dev
    ('tj-4t-case-dev', 'ts-4t-1', 'dev', 'case_converter dev',
     'FILENAME: case_converter.py
...
Write a Python function called convert_case(text, target) that converts text to ''lower'', ''upper'', ''kebab'', or ''camel'' case. Include an if __name__ == ''__main__'' block showing all four conversions.',
    ...
    -- case_converter: verifier
    ('tj-4t-case-ver', 'ts-4t-1', 'verifier', 'case_converter verifier',
     'FILENAME: case_converter.py
...
Write a Python function called convert_case(text, target) that converts text to ''lower'', ''upper'', ''kebab'', or ''camel'' case. Include an if __name__ == ''__main__'' block showing all four conversions.',
    ...
    -- all_join_in: tester
    ('tj-4t-join-test', 'ts-4t-2', 'tester', 'all_join_in tester',
     'FILENAME: all_join_in.py
INPUT_FILES: fibonacci.py,binary_sort.py,case_converter.py

Write a Python module that imports fibonacci from fibonacci, binary_sort from binary_sort, and convert_case from case_converter. Create a function called run_all() that demonstrates all three: print the first 10 Fibonacci numbers, sort a sample list of integers with binary_sort and print the result, then convert a few strings to all four case formats (''lower'', ''upper'', ''kebab'', ''camel'') using convert_case and print each. Include an if __name__ == ''__main__'' block that calls run_all().',
     'python -u harnesses/test_harness.py {{job_id}}',
     30, 600, NULL, NULL),

    -- all_join_in: dev
    ('tj-4t-join-dev', 'ts-4t-2', 'dev', 'all_join_in dev',
     'FILENAME: all_join_in.py
INPUT_FILES: fibonacci.py,binary_sort.py,case_converter.py
...
Write a Python module that imports fibonacci from fibonacci, binary_sort from binary_sort, and convert_case from case_converter. Create a function called run_all() that demonstrates all three: print the first 10 Fibonacci numbers, sort a sample list of integers with binary_sort and print the result, then convert a few strings to all four case formats (''lower'', ''upper'', ''kebab'', ''camel'') using convert_case and print each. Include an if __name__ == ''__main__'' block that calls run_all().',
    ...
    -- all_join_in: verifier
    ('tj-4t-join-ver', 'ts-4t-2', 'verifier', 'all_join_in verifier',
     'FILENAME: all_join_in.py
INPUT_FILES: fibonacci.py,binary_sort.py,case_converter.py
...
-- Set chain_id on four-tasks jobs (idempotent: safe to re-run)
UPDATE template_jobs SET chain_id = 'fibonacci'      WHERE template_job_id IN ('tj-4t-fib-test',   'tj-4t-fib-dev',   'tj-4t-fib-ver');
UPDATE template_jobs SET chain_id = 'binary_sort'    WHERE template_job_id IN ('tj-4t-bsort-test', 'tj-4t-bsort-dev', 'tj-4t-bsort-ver');
UPDATE template_jobs SET chain_id = 'case_converter' WHERE template_job_id IN ('tj-4t-case-test',  'tj-4t-case-dev',  'tj-4t-case-ver');
UPDATE template_jobs SET chain_id = 'all_join_in'    WHERE template_job_id IN ('tj-4t-join-test',  'tj-4t-join-dev',  'tj-4t-join-ver');

INSERT OR IGNORE INTO template_job_dependencies (template_job_id, depends_on_template_job_id, dependency_type) VALUES
    -- fibonacci chain
    ('tj-4t-fib-dev',   'tj-4t-fib-test',   'success'),
    ('tj-4t-fib-ver',   'tj-4t-fib-dev',    'completed'),
    -- binary_sort chain
    ('tj-4t-bsort-dev', 'tj-4t-bsort-test', 'success'),
    ('tj-4t-bsort-ver', 'tj-4t-bsort-dev',  'completed'),
    -- case_converter chain
    ('tj-4t-case-dev',  'tj-4t-case-test',  'success'),
    ('tj-4t-case-ver',  'tj-4t-case-dev',   'completed'),
    -- join waits for all 3 Stage 1 verifiers
    ('tj-4t-join-test', 'tj-4t-fib-ver',    'success'),
    ('tj-4t-join-test', 'tj-4t-bsort-ver',  'success'),
    ('tj-4t-join-test', 'tj-4t-case-ver',   'success'),
    -- join chain
    ('tj-4t-join-dev',  'tj-4t-join-test',  'success'),
    ('tj-4t-join-ver',  'tj-4t-join-dev',   'completed');

-- =====================================================================
-- TEMPLATE: Single TDD Task (user-defined prompt → tester → dev → verifier)
-- =====================================================================
INSERT OR IGNORE INTO pipeline_templates (template_id, name, description, default_vendor, default_model, created_at, updated_at) VALUES (
    'template-tdd-single',
    'Single TDD Task',
    'TDD chain for one user-defined task: tester writes tests, dev implements, verifier judges. One shared prompt drives all three roles.',
    'local-ollama', 'qwen3:8b',
    '2026-03-16T00:00:00Z', '2026-03-16T00:00:00Z'
);

INSERT OR IGNORE INTO template_stages (template_stage_id, template_id, name, stage_order) VALUES
    ('ts-tdd-1', 'template-tdd-single', 'tdd-task', 1);

INSERT OR IGNORE INTO template_jobs
    (template_job_id, template_stage_id, agent_type, name, prompt_template, command_template, max_iterations, timeout_seconds, vendor, model, chain_id)
VALUES
    ('tj-tdd-test', 'ts-tdd-1', 'tester',   'tester',   '{{original_prompt}}', 'python -u harnesses/test_harness.py {{job_id}}',   30, 600, NULL, NULL, 'task'),
    ('tj-tdd-dev',  'ts-tdd-1', 'dev',      'dev',      '{{original_prompt}}', 'python -u harnesses/dev_harness.py {{job_id}}',    30, 600, NULL, NULL, 'task'),
    ('tj-tdd-ver',  'ts-tdd-1', 'verifier', 'verifier', '{{original_prompt}}', 'python -u harnesses/verify_harness.py {{job_id}}', 20, 300, NULL, NULL, 'task');

INSERT OR IGNORE INTO template_job_dependencies (template_job_id, depends_on_template_job_id, dependency_type) VALUES
    ('tj-tdd-dev', 'tj-tdd-test', 'success'),
    ('tj-tdd-ver', 'tj-tdd-dev',  'completed');

-- Set chain_id on single TDD task jobs (idempotent)
UPDATE template_jobs SET chain_id = 'task' WHERE template_job_id IN ('tj-tdd-test', 'tj-tdd-dev', 'tj-tdd-ver');

-- =====================================================================
-- TEMPLATE CATEGORIES: Idempotent display-only groupings
-- =====================================================================
UPDATE pipeline_templates SET category = 'development'
    WHERE template_id IN ('template-full', 'simple-plan-code-verify', 'template-dev-test', 'template-dev-only', 'template-modify-existing', 'template-tdd-single')
    AND category IS NULL;
UPDATE pipeline_templates SET category = 'analysis'
    WHERE template_id IN ('template-test-only', 'template-plan-only')
    AND category IS NULL;
UPDATE pipeline_templates SET category = 'testing'
    WHERE template_id IN ('template-mock', 'template-four-tasks')
    AND category IS NULL;
